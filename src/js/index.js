...
const sortingTypeButtons = document.querySelectorAll(
  ".sorting-selection__button"
);
...
function getCardHTML(card) {
  ...
  <div class="course-card">
    ...
    <div class="course-card-content">
      <div class="course-card-main-description-wrapper">
      ...
      <div class="course-card-content-stats-wrapper">
        <div class="card-content-stats">
          ...
          <div class="card-content-stats__students-count-wrapper">
            ...
            <span class="card-content-stats__students-count">${numberFormat(
              card.studentsCount
            )} students</span>
          </div>
        </div>
...
function toggleSortingMenu() {
  if (sortingMenu.classList.contains("opened")) {
    ...
    const sortingTypeButtonsHeight = Array.from(sortingTypeButtons).reduce(
